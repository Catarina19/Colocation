...
<?php if ($valeur['id'] == $_SESSION['appart']){ ?>
    ...
    <div class="span12" id="divMain">
        <h1 style="text-align: center;">Message</h1><br>
        <form class="form" method="POST" action="index.php?action=mail_message" >
            <div class="span12">
                <div class="span6"><label for="expediteur">Votre adresse email : </label><input type="text" name="expediteur" required></div>
